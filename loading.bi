...
declare Sub SaveMenuData(menusfile AS STRING, menuitemfile AS STRING, dat AS MenuDef, record AS INTEGER)
declare Sub SaveMenuItems(menuitemfile AS STRING, mi() AS MenuDefItem, record AS INTEGER)
