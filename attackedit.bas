...
a_append atkbit(), 92, "##Always hide attacker (original broken bit)"
a_append atkbit(), 100, "Always hide attacker (after attacker animation)"
a_append atkbit(), 93, "Always unhide attacker (before attacker animation)"
