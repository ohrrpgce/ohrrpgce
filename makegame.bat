...
call fbc -lang deprecated -s gui -mt -m game game.bas hsinterpreter.bas bmod.bas bmodsubs.bas bcommon.bas allmodex.bas backends.bas lumpfile.bas menustuf.bas moresubs.bas yetmore.bas yetmore2.bas savegame.bas misc.bas bam2mid.bas %GFX_XTRAS% win32\blit.o win32\base64.o win32\array.o %MUSIC_XTRA% loading.bas common.bas browse.bas util.bas slices.bas reload.bas reloadext.bas os_windows.bas vector.bas menus.bas gicon.rc -d IS_GAME  %1 %2 %3 %4 %5 %6 %7 %8 %9
echo.
