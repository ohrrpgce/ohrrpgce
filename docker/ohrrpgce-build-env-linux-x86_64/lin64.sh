...
export DOCKERIMG=bobthehamster/ohrrpgce-build-env-linux-x86_64
...
while [[ $# -gt 0 ]]; do
  case $1 in
    -h|--help)
      cat <<EOF
Build and run an OHRRPGCE 64 bit Linux build environment in a docker image.
