...
CONST dissolveTypeMax = 11 'Highest numbered frame dissolve effect
...
CONST maxScriptCmdID = 694  'Max ID number of any supported script command (checked when loading game)
