...
#IFDEF IS_GAME
		...
		help = help & "-noexit             Disable exiting to OS from within the application" & LINE_END
...
#ENDIF
#IFDEF IS_CUSTOM
		help = help & "-distrib [zip|win|mac[32|64]|tarball[32|64]|debian[32|64]|web|all]" & LINE_END
