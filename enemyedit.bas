...
a_append enemybits(), 61, "Untargetable by hero team & win even if alive"
a_append enemybits(), 60, "Untargetable by enemy team"
...
FUNCTION enemy_edit_add_new (recbuf() as integer, preview_box as Slice ptr) as bool
  ...
  DIM preview as Slice ptr = LookupSlice(SL_SPRITE, preview_box)
  DIM state as MenuState
