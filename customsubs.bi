...
DECLARE FUNCTION pal16browse (BYVAL curpal AS INTEGER, usepic AS INTEGER, picx AS INTEGER, picy AS INTEGER, picw AS INTEGER, pich AS INTEGER, picpage AS INTEGER) AS INTEGER
