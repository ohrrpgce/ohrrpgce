...
2. Install Directions
 ...
 I have also included the original Uberzetsung version of Vikings 
 entitled "VIKINGS (old)" for those who want to peek at the older 
 version of the game and see how far it's come.  It's mostly for 
 nostalgia, but sometimes it's fun to look back and see what things 
...
3. Game Controls (Stolen Liberally from Wandering Hamster)
 ...
 X		*When held down on the map, allows the hero to run.
		(This button is unusable in the normal version)
