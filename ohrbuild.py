...
def runtime_lib_names(win32, android, libdir = None):
...
def verprint(mod, builddir, rootdir):
    """
    Generate backendinfo.bi, globals.bas, distver.bat.
    ...
    libs = runtime_lib_names(mod.win32, mod.android, mod.libdir)
    ...
    globals_bas = [
        ...
        'DIM libsdl_name as string : libsdl_name = "%(SDL)s"' % libs,
        'DIM libsdl2_name as string : libsdl2_name = "%(SDL2)s"' % libs,
        'DIM libsdl_mixer_name as string : libsdl_mixer_name = "%(SDL_mixer)s"' % libs,
        'DIM libsdl2_mixer_name as string : libsdl2_mixer_name = "%(SDL2_mixer)s"' % libs,
    ]
