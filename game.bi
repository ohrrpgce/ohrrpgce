...
DECLARE SUB update_virtual_gamepad_display(byval advancing_text_now as bool=NO)
DECLARE FUNCTION calc_virtual_gamepad_state(byval advancing_text_now as bool=NO) as bool
