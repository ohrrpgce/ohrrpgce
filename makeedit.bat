...
REM makeedit [graphics_backends...] [~] [music_backend] [extra_options]

REM Usage example (gfx_directx, gfx_sdl, music_sdl debugging build):
REM  makeedit directx sdl ~ sdl -g
...
call fbc -lang deprecated -s gui -mt -m custom custom.bas customsubs.bas drawing.bas subs.bas subs2.bas mapsubs.bas flexmenu.bas subs4.bas allmodex.bas backends.bas lumpfile.bas misc.bas bam2mid.bas slices.bas sliceedit.bas reload.bas reloadext.bas reloadedit.bas editedit.bas editrunner.bas %GFX_XTRAS% win32\blit.o win32\base64.o win32\array.o %MUSIC_XTRA% loading.bas common.bas bcommon.bas browse.bas util.bas os_windows.bas vector.bas menus.bas cicon.rc -d IS_CUSTOM  %1 %2 %3 %4 %5 %6 %7 %8 %9
echo.
