...
call fbc -lang deprecated -s gui -mt -m custom custom.bas customsubs.bas drawing.bas subs.bas subs2.bas mapsubs.bas flexmenu.bas menus.bas allmodex.bas backends.bas lumpfile.bas compat.bas bam2mid.bas slices.bas sliceedit.bas reload.bas reloadext.bas reloadedit.bas %GFX_XTRAS% win32\blit.o win32\base64.o %MUSIC_XTRA% loading.bas common.bas browse.bas util.bas cicon.rc -d IS_CUSTOM  %1 %2 %3 %4 %5 %6 %7 %8 %9
echo.
