...
//moved to gfx_directx_version.h
...
//moved to gfx_directx_TESTAPPconst.h
...
void gfx_setpal(unsigned int *pal)
{
	...
	gfx_showpage(0,0,0/*g_pRaw, g_pRawSize.cx, g_pRawSize.cy*/); //necessary because allmodex assumes the screen is updated here, which is a bad assumption
}
...
void io_pollkeyevents()
{
	...
	gfx_showpage(0,0,0/*g_pRaw, g_pRawSize.cx, g_pRawSize.cy*/); //must be here because of implied draw (why is there an implied draw on this function call?)
}
