...
declare function inflict (w, t, bstat() AS BattleStats, bslot() as battlesprite, harm$(), hc(), hx(), hy(), atk(), tcount, bits(), revengeharm(), repeatharm())
...
declare sub smartarrowmask (inrange(), pt, d, axis, bslot() as battlesprite, targ AS TargettingState)
declare sub smartarrows (pt, d, axis, bslot() as battlesprite, targ AS TargettingState, spred)
