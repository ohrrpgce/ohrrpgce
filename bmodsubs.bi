...
declare sub autotarget OVERLOAD (who AS INTEGER, atk_id AS INTEGER, bslot() AS BattleSprite, queue AS INTEGER=YES)
declare sub autotarget OVERLOAD (who, atk AS AttackData, bslot() AS BattleSprite, queue AS INTEGER=YES)
