...
declare sub autotarget OVERLOAD (who AS INTEGER, atk_id AS INTEGER, bslot() AS BattleSprite, t() AS INTEGER, queue AS INTEGER=YES, override_blocking AS INTEGER=-2)
declare sub autotarget OVERLOAD (who, atk AS AttackData, bslot() AS BattleSprite, t() AS INTEGER, queue AS INTEGER=YES, override_blocking AS INTEGER=-2)
